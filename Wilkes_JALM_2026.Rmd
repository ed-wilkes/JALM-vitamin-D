...
df_stability <- read.csv("~/Wilkes_JALM_stability_data.csv")
df_temp <- read.csv("~/Wilkes_JALM_temperature_data.csv")
df_time <- read.csv("~/Wilkes_JALM_transit_time_data.csv")
```
...
ggsave("Fig5.png", dpi = 450, width = 13, height = 13)
```
